const verbes = [
    ...
    { spelling: 'cloner', group: 1, table: 3},      { spelling: 'compacter', group: 1, table: 3 },
    { spelling: 'anonymiser', group: 1, table: 3},  { spelling: 'coéditer', group: 1, table: 3 },
    { spelling: 'auditer', group: 1, table: 3},     { spelling: 'annualiser', group: 1, table: 3 },
    { spelling: 'castrer', group: 1, table: 3},     { spelling: 'candidater', group: 1, table: 3},
    { spelling: 'cibler', group: 1, table: 3},      { spelling: 'assoiffer', group: 1, table: 3},
    { spelling: 'coanimer', group: 1, table: 3},    { spelling: 'contrebraquer', groupe: 1, table: 3},
    { spelling: 'contre-braquer', groupe: 1, table: 2}
];
