const endings_ = {
    '1':{  //  être
        ...
        imperatif: { présent: ['sois', 'soyons', 'soyez'] }
    },
    '2':{  //  avoir
        suffix: '',
        indicatif: {
    ...
    '24':{  // verbes en -eter qui double le t. Retirer le suffixe er.
        suffixe: 'er',
        indicatif: {
            présent:   ['te', 'tes', 'te', 'ons', 'ez', 'tent'],
            imparfait: ['ais', 'ais', 'ait', 'ions', 'iez', 'aient'],
            passe:     ['ai', 'as', 'a', 'âmes', 'âtes', 'èrent'],
            futur:     ['terai', 'teras', 'tera', 'terons', 'terez', 'teront'],
        },
        subjonctif: {
            présent:   ['te', 'tes', 'te', 'tions', 'tiez', 'tent'],
            imparfait: ['asse', 'asse', 'ât', 'assions', 'assiez', 'assent']
        },
        conditionnel: { présent:   ['terais', 'terais', 'terait', 'terions', 'teriez', 'teraient'] },
        participe: {
            présent:   ['ant'],
            passé:     ['é', 'ée', 'ées','és']
        },
    ...
    '26': {  //  verbes en -uyer. Retirer le suffixe -yer
        ...
        subjonctif: {
            présent:   ['ie', 'ies', 'ie', 'yions', 'yiez', 'ient'],
            imparfait: ['yasse', 'yasses', 'yât', 'yassions', 'yassiez', 'yassent']
        },
        conditionnel: {
            présent:   ['ierais', 'ierais', 'ierait', 'ierions', 'ieriez', 'ieraint'],
        },
        participe: {
            présent:   ['yant'],
